...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            ...
            removeConfirmation: 'Estas seguro de eliminar este logo?',
            errors: {
                filesLimit: 'Solo imagenes ${limit} pueden ser cargados.',
                filesType: 'Solo imagenes ${extensions} pueden ser cargados.',
