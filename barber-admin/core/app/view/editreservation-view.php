...
<form class="form-horizontal" role="form" method="post" action="./?action=updatereservation">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Nota</label>
      ...
      <div class="col-lg-4">
          <textarea class="form-control" name="precio" id="precio" placeholder="$"><?php echo $reservation->precio;?></textarea>
      </div>
  ...
  <div class="form-group">
     <label for="inputEmail1" class="col-lg-2 control-label">Estado del pago</label>
      ...
      <div class="col-lg-4">
          <input <?php if ($reservation->forma_pago=="tarjeta"){echo'checked';} ?> value="tarjeta" name="forma_pago"  type="radio" > Tarjeta <br>
          <input <?php if ($reservation->forma_pago=="efectivo"){echo'checked';}?> value="efectivo" name="forma_pago"  type="radio"> Efectivo<br>
