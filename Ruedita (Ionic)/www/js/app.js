...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, appConfig) {
  ...
  .state('tab.destacado', {
    ...
    views: {
      'mainContent': {
        templateUrl: 'templates/'+appConfig.ENABLE_THEME+'/tab-home-bu.html',
        controller: 'HomeCtrl'
      }
    }
  })
  ...
  .state('tab.horarios', {
    ...
    views: {
      'mainContent': {
        templateUrl: 'templates/'+appConfig.ENABLE_THEME+'/tab-horarios.html',
        controller: 'ContactUsCtrl'
      }
    }
  })
  ...
  .state('tab.contacto', {
    ...
    views: {
      'mainContent': {
        templateUrl: 'templates/'+appConfig.ENABLE_THEME+'/tab-contacto.html',
        controller: 'ContactUsCtrl'
      }
    }
  })
  ...
  .state('tab.about', {
    ...
    views: {
      'mainContent': {
        templateUrl: 'templates/'+appConfig.ENABLE_THEME+'/tab-about.html',
