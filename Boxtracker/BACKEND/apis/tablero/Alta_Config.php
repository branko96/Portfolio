...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	//LLAMO A LA FUNCION CON LOS PARAMETROS
		$rta=$tableroController->AltaConfig($body['id_tablero'], $body['paleta_color'],$body['tamanio'], $body['id_tools'], $body['coor_x'], $body['coor_y'],$body['escritorio'],$body['nombre_herramienta']);
