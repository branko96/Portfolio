<?php
	...
	Class Tablero{
		...
		protected $paleta_color;
		protected $tamanio;	 
		protected $estado;
		protected $visible;   
		
		public function __construct($id,$id_proyecto,$idusuario_creador,$nombre_tablero,$fecha_creacion,$tipo_periodo,$cant_periodos,$paleta_color,$tamanio,$estado,$visible)
		{
			$this->id = sprintf($id);
	    	...
	    	$this->paleta_color = sprintf($paleta_color);
	    	$this->tamanio = sprintf($tamanio);
